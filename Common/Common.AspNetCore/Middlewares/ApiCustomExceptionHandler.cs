...
public class ApiCustomExceptionHandlerMiddleware
{
    ...
    public ApiCustomExceptionHandlerMiddleware(RequestDelegate next, IHostingEnvironment env, ILogger<ApiCustomExceptionHandlerMiddleware> logger)
    {
        _next = next;
        _env = env;
        _logger = logger;
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        var apiStatusCode = AppStatusCode.ServerError;
